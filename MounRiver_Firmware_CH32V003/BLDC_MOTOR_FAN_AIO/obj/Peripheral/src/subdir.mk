...
Peripheral/src/%.o: ../Peripheral/src/%.c
	@	riscv-none-embed-gcc -march=rv32ecxw -mabi=ilp32e -msmall-data-limit=0 -msave-restore -fmax-errors=20 -fdump-rtl-expand -Os -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -fno-common -Wunused -Wuninitialized -g -I"d:/Harry/ADC2PWM/MounRiver_Firmware_CH32V003/BLDC_MOTOR_FAN_AIO/Debug" -I"d:/Harry/ADC2PWM/MounRiver_Firmware_CH32V003/BLDC_MOTOR_FAN_AIO/Core" -I"d:/Harry/ADC2PWM/MounRiver_Firmware_CH32V003/BLDC_MOTOR_FAN_AIO/User" -I"d:/Harry/ADC2PWM/MounRiver_Firmware_CH32V003/BLDC_MOTOR_FAN_AIO/Peripheral/inc" -std=gnu99 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
